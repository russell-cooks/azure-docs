...
|Rectangle|Rectangular region relative to the image top left corner. The required properties will be "length", "width", height" and "top edge distance from the origin". These property values must be normalized between 0 and 1.|
